...
iii.Mains Control Loop: The AC mains input feeds directly into the two-pole MCB. The output of the MCB is wired in series with the parallel bulb ballast network, which then connects in series to the parallel primary inputs of the MOT assembly.
